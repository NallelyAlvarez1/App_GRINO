...
if is_logged_in:
    ...
    .card-color-1 { background: linear-gradient(135deg, #f43f5e 0%, #fda4af 100%); }
    .card-color-2 { background: linear-gradient(135deg, #f97316 0%, #fde047 100%); }
    .card-color-3 { background: linear-gradient(135deg, #2563eb 0%, #38bdf8 100%); }
    .card-color-4 { background: linear-gradient(135deg, #7c3aed 0%, #c084fc 100%); }
